...
class Candidateskills_model extends CI_Model
{
	private $apiUrl='http://192.168.1.151/lexusjobsapi/CandidateskillsApi.php';
	//private $apiUrl='http://localhost:8080/lexusjobsapi/CandidateskillsApi.php';
	function post($data)
	 { 
