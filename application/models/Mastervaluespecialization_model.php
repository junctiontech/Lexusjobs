...
class Mastervaluespecialization_model extends CI_Model
{
	//private $apiUrl='http://192.168.1.151/lexusjobsapi/MastervaluespecializationApi.php';
	private $apiUrl='http://localhost:8080/lexusjobsapi/MastervaluespecializationApi.php';
	function post($data)
	 { 
