				...
				<div class="panel-body">
					<form role="form" class="form-horizontal" method="post" onsubmit="return addrequriment_validation()" action="<?php echo base_url();?>Master/projectRequiermentPost">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<textarea rows="4" cols="50" maxlength="300" type="text" class="form-control input-lg" id="jobDescription" name="jobDescription"  placeholder="Please Enter job Description" value="" required><?php if(isset($requierment[0]->jobDescription)){ echo $requierment[0]->jobDescription;}?></textarea>
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<input type="text" maxlength="20" class="form-control input-lg" name="salary" id="salary" value="<?php if(isset($requierment[0]->salary)){ echo $requierment[0]->salary;}?>" required>
						...
						<div class="form-group">						
							...
							<div class="col-sm-4">
								<input type="text" maxlength="40" class="form-control input-lg" id="projectLocation" name="projectLocation"  placeholder="Please Enter project Location" value="<?php if(isset($requierment[0]->projectLocation)){ echo $requierment[0]->projectLocation;}?>" required>
							...
							<div class="col-sm-4">
								<select class="form-control input-lg" id="maxQualification" name="maxQualification"  value="<?php if(isset($requierment[0]->maxQualification)){ echo $requierment[0]->maxQualification;}?>" required>
