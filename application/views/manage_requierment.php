		...
		<div class="panel panel-default">
			<div class="panel-heading">
				...
				<div class="panel-options">
					<a href="<?php echo base_url(); ?>Master/projectRequirementUpdate?projectID=<?=$id?>">
						...
						<tbody>
							...
							<tr>
								...
								<td>	
									...
									<a href="<?php echo base_url(); ?>Master/projectRequirementUpdate?projectID=<?=$id?>&requiermentID=<?=$list->projectRequirementID;?>" class="btn btn-secondary btn-sm btn-icon icon-left"><i class="fa-pencil-square-o"></i> Edit </a>
