	...
	<script type="text/javascript">
				...
				$(document).ready(function(){
				    ...
				    $(".add-more").click(function(e){
				        ...
				        next = next + 1;
				        var newIn = '<input autocomplete="off" placeholder="Please Enter Master Entry " class="input form-control" id="field' + next + '" name="masterEntryValue[]" type="text">';
				        var newInput = $(newIn);
				        ...
				        var addRemove = "#field" + (next);
				        next = next + 1;
				        var newIn = '<input autocomplete="off" placeholder="Please Enter Master Entry " class="input form-control" id="field' + next + '" name="masterEntryName[]" type="text">';
				        var newInput = $(newIn);
				        var removeBtn = '<button id="remove' + (next - 1) + '" class="btn btn-danger remove-me" >-</button></div><div id="field">';
				        var removeButton = $(removeBtn);
				        $(addto).after(newInput);
