...
<div class="page-title">
	<div class="title-env">
		<h1 class="title">Manage Partner</h1>
		<p class="description">Manage Partner</p>
	</div>
		...
		<div align="center">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">Manage Partner</h3>
					<div class="panel-options">
						<a href="<?php echo base_url(); ?>Master/partnerUpdate/">
							<button class="btn btn-theme btn-info btn-icon btn-sm"><i class="fa-plus"></i> <span>Add Partner</span></button>
						</a>
					</div>
				</div>
