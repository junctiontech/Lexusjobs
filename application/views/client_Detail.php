				...
				<div class="panel-body">
					<form role="form" class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>Master/clientPost/">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control input-lg"  maxlength="30" name="contactPerson" placeholder=" Enter Contact Person"value="<?php if(isset($clientupdate[0]->contactPerson)){ echo $clientupdate[0]->contactPerson; }?>" required>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control input-lg" id="onlyNumber" maxlength="12" name="contactNumber" placeholder="Please Enter Contact Number" value="<?php if(isset($clientupdate[0]->contactNumber)){ echo $clientupdate[0]->contactNumber;}?>" required>
							</div>
						</div>
						<div class="form-group">
